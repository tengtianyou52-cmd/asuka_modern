import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, shallowRef, h, resolveComponent, computed, unref, ref, inject, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, withCtx, createTextVNode, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/h3/dist/index.mjs';
import { RouterView, useRoute as useRoute$1, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, parseURL, encodePath, decodePath, isScriptProtocol, withQuery, withTrailingSlash, withoutTrailingSlash } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderClass } from 'file://C:/Users/yuma/Desktop/asuka-modern/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "qa",
    path: "/qa",
    component: () => import('./qa-DRiUEmWV.mjs')
  },
  {
    name: "flow",
    path: "/flow",
    component: () => import('./flow-DwEHn2hh.mjs')
  },
  {
    name: "plan",
    path: "/plan",
    component: () => import('./plan-D9rYu9AU.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-RvEWHeID.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import('./terms-DT7o4Psq.mjs')
  },
  {
    name: "apparel",
    path: "/apparel",
    component: () => import('./apparel-EquPs79U.mjs')
  },
  {
    name: "company",
    path: "/company",
    component: () => import('./company-fRIGksYu.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-CDLn13Ef.mjs')
  },
  {
    name: "oem-odm",
    path: "/oem-odm",
    component: () => import('./oem-odm-B_IOYn9B.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import('./privacy-ivxkSQmY.mjs')
  },
  {
    name: "shipping",
    path: "/shipping",
    component: () => import('./shipping-CReXa22K.mjs')
  },
  {
    name: "amazon-fba",
    path: "/amazon-fba",
    component: () => import('./amazon-fba-B1oyrLdw.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DWGIDDKC.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bq7Jkj-9.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, entry_default as default, tryUseNuxtApp as t };
